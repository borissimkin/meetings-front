...
export const ERROR_MEDIA_DEVICES = 'Дайте доступ к медиаустройствам и перезагрузите страницу'
...
export const ERROR_DATA_DOWNLOAD = 'Произошла ошибка загрузки данных, перезагрузите страницу'
...
export const CURRENT_USER_RESET_PREPARATION_TO_EXAM = 'Ваше время подготовки сброшено'
...
export const SET_RESPONDED_USER = (firstName, lastName) => `${getFullName(firstName, lastName)} отвечает`
export const ERROR_SYNC_WHITEBOARD = 'Произошла ошибка синхронизации доски, ' + 'перезагрузите страницу'
export const CURRENT_USER_CAN_DRAWING = 'Вам дали право рисовать'
export const CURRENT_USER_CAN_NOT_DRAWING = 'У вас забрали право рисовать'
